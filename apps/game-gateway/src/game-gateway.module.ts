...
import { GameController } from '@microservice-platform/game-gateway/controllers';
...
import { HealthModule } from '@microservice-platform/game-gateway/health/health.module';
